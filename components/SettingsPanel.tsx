...
const ENV_VARS = [
  { key: "UPSTASH_REDIS_REST_URL", desc: "Upstash Redis REST URL", from: "Vercel Storage" },
  { key: "UPSTASH_REDIS_REST_TOKEN", desc: "Upstash Redis REST token", from: "Vercel Storage" },
